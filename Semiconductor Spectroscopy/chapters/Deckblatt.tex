...
\newcommand{\gruppennummer}{8} %Gruppennummer:
...
\newcommand{\semester}{9/9} %Semester:
\newcommand{\versuch}{Semiconductor Spectroscopy} %Versuch:
\newcommand{\nameeins}{Tobias von Möllendorf} %Name1 (Vor und Nachname):
\newcommand{\emaileins}{tobias.moellendorf@student.kit.edu} %E-Mail 1:
\newcommand{\namezwei}{Felix Schwarz} %Name2 (Vor und Nachname):
\newcommand{\emailzwei}{felix.schwarz2@student.kit.edu} %E-Mail 2:
\newcommand{\assistent}{Dr. Roland Gröger} %Assistent*in:
\newcommand{\durchfuehrungsdatum}{Monday, 17.11.2025} %Durchgeführt am:
