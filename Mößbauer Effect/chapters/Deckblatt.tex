...
\newcommand{\nameeins}{Tobias von Möllendorff} %Name1 (Vor und Nachname):
\newcommand{\emaileins}{tobias.moellendorff@student.kit.edu} %E-Mail 1:
\newcommand{\namezwei}{Felix Schwarz} %Name2 (Vor und Nachname):
\newcommand{\emailzwei}{felix.schwarz2@student.kit.edu} %E-Mail 2:
\newcommand{\assistent}{Alexey Lokhov} %Assistent*in:
\newcommand{\durchfuehrungsdatum}{Monday, 15.12.2025} %Durchgeführt am:
