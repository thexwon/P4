...
\newcommand{\semester}{3 / 1} %Semester:
\newcommand{\versuch}{MOKE} %Versuch:
...
\newcommand{\assistent}{Tajamul Islam} %Assistent*in:
\newcommand{\durchfuehrungsdatum}{Friday, 07.11.2025} %Durchgeführt am:
