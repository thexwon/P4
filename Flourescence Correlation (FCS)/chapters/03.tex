...
The confocal volume, i.e. the illuminated sample volume, is usually of the order of a femtoliter, which covers only a small part of the sample. To construct an image of the whole sample, the microscopy needs to scan the sample, usually done in a square grid configuration by angling a mirror in front of the objective.

Single-molecule detection is possible in a confocal fluorescence microscope because the point-like focused excitation spot and the pinhole drastically reduce the background signal. With few fluorophores present in the femtoliter observation volume, their emission appears as distinct photon bursts that can be detected with sensitive detectors such as Single Photon Avalanche Diodes. To separate fluorescence emission and source light, a dichroic mirror is used.
